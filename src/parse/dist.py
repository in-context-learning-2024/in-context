...
def get_distribution(batch_shape: torch.Size, event_shape: torch.Size, init_kwargs: dict) -> D.Distribution:
    ...
    check_kwargs(DISTRIBUTION_BANK, init_kwargs, "Distribution")
...
def get_x_distribution(batch_size: int, seq_len: int, x_dim: int, init_kwargs: dict) -> D.Distribution:
