...
from .inferencing_fns_llama import block_var_declare_llamamamba, forward_block_llamamamba, block_var_declare_llamasinglemamba, forward_block_llamasinglemamba
...
class LlamaSingleMambaModel(ModSeqModelLlama):
    def __init__(self, x_dim, n_positions, n_embd=128, n_layer=12, n_head=4, want_rope=True, custom_attn_func = None, hidden_act="silu", rope_theta=1e4, num_mamba_layers=1, num_mamba_instances=1, **kwargs):
        ...
        self.change_llama_block(block_var_declare_llamasinglemamba, [MambaModel(mamba_configuration) for _ in range(num_mamba_instances)], forward_block_llamasinglemamba)
