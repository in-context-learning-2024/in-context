...
def block_var_declare_llamasinglemamba(self, this_mamba_model):
    self.norm_f = this_mamba_model[0].norm_f
    self.mamba_blocks = list(this_mamba_model[0].layers)

def forward_block_llamasinglemamba(
        self,
